<%-- 
    Document   : Payment
    Created on : 8 Mar, 2022, 11:29:03 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <br/><br/>
        <div class="result">
            <h3 align="center">Payment process</h3><br/><br/>
            <form style="text-align: center">
                <h4>Enter username of citizen: <input type="text" name="userr"/></h4>
                <br/>
                <h4> Select the Tax type to be paid: 
                    <select name="item">
                ...
                <br/>
                <h4 align="center">Enter the amount to be paid: <input type="number" name="am"/></h4>
                <br/>
                <h4 align="center">Enter the card number: <input type="number" name="card" maxlength="16"/></h4>
                <br/>
                <h4 align="center">Enter the expiry date: <input type="text" name="exp"/></h4>
                <br/>
                <h4>Enter the CVV: <input type="password" name="cvv" maxlength="3"/></h4>
                <br/>
            ...
            %>
            <h3 align="center"><a href='Login.html'>Proceed</a></h3>
        </div>
    </body>
</html>